...
/**
 * Persistent Compare chip. Always visible in Library and Foundry toolbars.
 * Links to /compare. Count updates live from the shared queue.
 */
export function CompareChip({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <span
        className={
          "ml-1 inline-flex min-w-[1.25rem] items-center justify-center rounded-md px-1.5 text-[10px] font-mono-ui tabular-nums " +

...
export function SavedPairings() {
  ...
  return (
    <section className="tm-saved-panel">
      <div className="tm-section-heading !mb-0">
        <div>
          <span className="label-eyebrow">Saved pairings</span>
          <h2 className="font-editorial mt-2 text-2xl tracking-tight">Your local shortlist</h2>
        </div>
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground" style={{ fontFamily: sFamily }}>
                      + {it.secondaryName}
                    </p>
                  </div>
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-md border border-border bg-card px-2 py-1 text-[11px] uppercase tracking-[0.14em] text-muted-foreground hover:border-foreground hover:text-foreground"
                  >
                    <X size={12} /> Remove
                  </button>
                </div>

                <div className="flex flex-wrap gap-3 text-[11px] uppercase tracking-[0.14em] text-muted-foreground">
                  <span>Risk · {it.riskLevel}</span>
                  <span>Confidence · {it.confidence}</span>
                </div>

                <p className="text-xs leading-relaxed text-foreground">{it.shortExplanation}</p>
              </li>
            );
          })}
        </ul>
